              ...
              <>
                <div className="relative group">
                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-10 hidden group-hover:block">
                    ...
                    {auth.user?.is_admin && (
                      <Link to="/admin/signals" className="block px-4 py-2 text-gray-800 hover:bg-primary hover:text-white">Manage Signals</Link>
                    )}
            ...
            <div className="flex flex-col space-y-2">
              ...
              {auth.isAuthenticated ? (
                <>
                  ...
                  {auth.user?.is_admin && (
                    <Link to="/admin/signals" className="py-2 hover:bg-primary-light px-4 rounded">Manage Signals</Link>
                  )}
